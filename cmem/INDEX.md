...
| [build-and-release.md](build-and-release.md) | The build → publish → ISO pipeline: workflows, the Cosign signing requirement, build order, and how the titanoboa ISO is produced. |
| [decisions.md](decisions.md) | Load-bearing design decisions that must not be silently reverted (base choice, COSMIC layering method, keep-GDM, titanoboa over BIB). |
